...
import me.xueyao.entity.PageDomain;
import me.xueyao.entity.SysUser;
import me.xueyao.entity.TableSupport;
import me.xueyao.mapper.BizLeaveMapper;
...
public class BizLeaveServiceImpl implements IBizLeaveService {
    ...
    public List<BizLeaveVo> selectBizLeaveList(BizLeaveVo bizLeave) {
        Integer pageNum = bizLeave.getPageNum();
        Integer pageSize = bizLeave.getPageSize();
